public class Datos {
    ...
    public static double[] kmAmbulancias = new double[10]; // Kilómetros por ambulancia
    public static int[] recorridosPorConductor = new int[10]; // Recorridos por conductor
}